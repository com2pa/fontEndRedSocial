...
export function Menu() {
  ...
  return (
    <>
      ...
      <Box>
        <Flex
          bg={useColorModeValue('blue.200', 'White.300')}
          color={useColorModeValue('blue.200', 'White.300')}
          minH={'60px'}
          py={{ base: 2 }}
          px={{ base: 4 }}
          borderBottom={1}
          borderStyle={'solid'}
          borderColor={useColorModeValue('blue.200', 'White.300')}
          align={'center'}
        >
          <Flex
            flex={{ base: 1, md: 'auto' }}
  ...
  return (
    ...
    >
      <Box
        ...
        _hover={{
          textDecoration: 'none',
          bgColor: useColorModeValue('blue.200', 'white.200'),
        }}
      >
        <Text
          fontWeight={600}
